<script>
  import MyFooter from "../22_插槽/01_src_默认插槽/components/MyFooter.vue";
  import MyList from "../22_插槽/01_src_默认插槽/components/MyList.vue";
  import MyHeader from "../22_插槽/01_src_默认插槽/components/MyHeader.vue";
